...
const getDefaultDates = () => {
  ...
  const independenceDay = getHolidayByDay(7, 4, year, nextYear)
  const halloween = getHolidayByDay(10, 31, year, nextYear)
  const mlkDay = getHolidayByDay(1, 17, year, nextYear)
  const valentinesDay = getHolidayByDay(2, 14, year, nextYear)
  const boxingDay = getHolidayByDay(12, 26, year, nextYear)
  const newYearsDay = getHolidayByDay(1, 1, year, nextYear)
